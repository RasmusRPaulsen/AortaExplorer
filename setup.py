...
setup(name='AortaExplorer',
        version='1.1.0',
        description='Segmentation and quantification of the human aorta in CT scans',
        long_description="See Readme.md on github for more details.",
        url='https://github.com/RasmusRPaulsen/AortaExplorer',
        author='Rasmus R. Paulsen',
        author_email='rapa@dtu.dk',
        python_requires='>=3.9',
        license='MIT',
